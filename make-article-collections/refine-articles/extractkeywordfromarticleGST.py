...
# aliases = ['Digital India','digital india','Digital Swades','digital swades','India Digital','india digital','Digit India','digit india','Digital Desh','digital desh','make india','digital divide','digital payment','free wifi service','digital locker','digital transaction','wifi hotspot','budget cybersecurity','skill india','internet connectivity','smart city','digital business','bharatnet project','digital present','Bharat net','digitalised','digitalized']
