...
# aliases = ['Aadhar', 'Aadhaar', 'Adhar', 'Adharcard', 'Aadharcard', 'Aadhaarcard', 'UIDAI', 'Aadhar Card']
# aliases = ['GST', 'Goods and Services Tax', 'Goods & Services Tax', 'excise duty']
# aliases = ['demonitis', 'demonitiz', 'denomination note', 'cash withdrawal', 'swipe machine', 'unaccounted money', 'withdrawal limit', \
#    'pos machine', 'fake currency', 'digital payment', 'digital transaction', 'cash transaction', 'cashless economy', 'black money', \
#    'cash crunch', 'currency switch', 'long queue', 'demonetised note', 'cashless transaction', 'note ban', 'currency switch', 'demonetis', 'demonetiz']
# aliases = ['loan waiver', 'farmer loan', 'farmer suicide', 'pest infestation', 'Swaminathan Commission', 'National Commission on Farmer',\
#     'kisan', 'monsoon failure', 'crop failure', 'fertilizers', 'Seeds Corporation', 'farmer', 'agricultural']
aliases = ['technology', 'technological', 'innovation', 'software', 'engineering', 'high technology',\
            'technical', 'tech']
...
class StanfordNLP:
    def __init__(self, host='http://localhost', port=9000):
        ...
        # self.nlp = StanfordCoreNLP('http://localhost:9000')  # , quiet=False, logging_level=logging.DEBUG)
